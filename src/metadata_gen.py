...
4️⃣ 主視覺生成與快取說明
----------------------------------------------------------------------
上述提示詞只使用查得的小說資訊，不固定指定仙俠、人物性別、宮殿或法術。無文字主視覺固定快取於 Cover/master_cover.jpg；各 Part 只在其複本上疊加書名，作品完結時另於右上角顯示「已完結」；不顯示部數或章節範圍。
======================================================================
"""
